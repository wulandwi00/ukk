        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <div class="dropdown nav navbar-top-links navbar-right pull-right">
                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding: px; margin: 15px;">
                        Admin
                    </button>
                ...
                <!-- <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        <a class="profile-pic" href="#"> <i class="fa fa-user"style="margin-right:15px; font-size:25px;"></i><b class="hidden-xs" style="font-size:16px;">ADMIN</b></a>
                    </li>
                </ul> -->
            </div>
            <!-- /.navbar-header -->
